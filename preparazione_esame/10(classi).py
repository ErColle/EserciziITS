...
class Movie: 
    def __init__(self, moovie_id: str, title: str, director: str):
        
        self.moovie_id = moovie_id
        self.title = title 
    ...
    def rent(self):
        if self.is_rented is True:
            print(f"Il film 'Il film {self.title}' è già noleggiato.")
        else:
            self.is_rented = True
            
    def return_movie(self):
        if self.is_rented is not True:
            print(f"Il film 'Il film {self.title}' non è già noleggiato da questo cliente.")
        else:
            self.is_rented = False
...
class VideoRentalStore:
    def __init__(self):
        self.movies: dict[str, Movie]  = {} #chiave id film, valore oggetto Movie
        self.customers: dict[str, Customer] = {} #chiave id cliente,  valore oggetto customer
    ...
    def get_rented_movies(self, customer_id: str):
        if customer_id in self.customers:
            print(f"{self.customers[customer_id].rented_movies}")
        else: 
